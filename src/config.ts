...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    // site description
    description: 'Daytripper is a personal blog that explores the wonders of the world, one day at a time. Join me on my adventures as I share stories, insights, and experiences from my travels and daily life.',
    // use i18n title/subtitle/description from src/i18n/ui.ts instead of static ones above
    i18nTitle: true, // true, false
    // author name
    author: 'https://instagram.com/scott_shih',
    // site url
    url: 'https://daytripper.tw',
    // favicon url
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'Email',
        url: 'mailto:rockstone7000@gmail.com',
      },
      // {
      //   name: 'X',
